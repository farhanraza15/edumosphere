...
import com.edumosphere.lms.web.RoleController;
...
privileged aspect RoleController_Roo_Controller {
    ...
    public String RoleController.show(@PathVariable("roleid") Long roleid, Model uiModel) {
    ...
    public String RoleController.updateForm(@PathVariable("roleid") Long roleid, Model uiModel) {
        populateEditForm(uiModel, Role.findRole(roleid));
        return "roles/update";
    }
    
    @RequestMapping(value = "/{roleid}", method = RequestMethod.DELETE, produces = "text/html")
    public String RoleController.delete(@PathVariable("roleid") Long roleid, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
