...
privileged aspect UserController_Roo_Controller {
    ...
    public String UserController.show(@PathVariable("userid") Long userid, Model uiModel) {
    ...
    public String UserController.updateForm(@PathVariable("userid") Long userid, Model uiModel) {
        populateEditForm(uiModel, User.findUser(userid));
        return "users/update";
    }
    
    @RequestMapping(value = "/{userid}", method = RequestMethod.DELETE, produces = "text/html")
    public String UserController.delete(@PathVariable("userid") Long userid, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
